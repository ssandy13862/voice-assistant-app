...
public class ItemConversationBindingImpl extends ItemConversationBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.userText, 1);
        sViewsWithIds.put(R.id.aiText, 2);
        sViewsWithIds.put(R.id.timestampText, 3);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((com.voiceassistant.app.domain.model.ConversationItem) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItem(@Nullable com.voiceassistant.app.domain.model.ConversationItem Item) {
        this.mItem = Item;
    }
